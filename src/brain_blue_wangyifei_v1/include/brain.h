...
#include "brain_blue_wangyifei_v1/msg/kick.hpp"
...
public:
    ...
    // Exact Webots world truth used only when game.sim_ground_truth=true.
    void simWorldStateCallback(const std_msgs::msg::String::SharedPtr msg);
...
private:
    ...
    void updateRecoveryFsm();
    void enterRecoveryState(RecoveryFsmState state);
    bool isRecoveryUprightStable() const;
    void blockMotionDuringRecovery();
    void finishRecovery();
    void sendStandUpRequest();
    double recoveryMsecsSince(const rclcpp::Time &time);
    ...
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr simWorldStateSubscription;
    ...
    rclcpp::Publisher<brain_blue_wangyifei_v1::msg::Kick>::SharedPtr pubKickBall;
